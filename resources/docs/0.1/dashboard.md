...
El Dashboard es la **pantalla principal** del panel. Te da un resumen rápido del estado de tu cuenta y de la actividad reciente.
...
- **Chats abiertos** — Conversaciones activas.
- **Sin leer** — Mensajes del visitante que todavía no respondiste.
...
- Hacé click en cualquier tarjeta de métrica para ir a la sección correspondiente.
- Desde el header, click en tu nombre de usuario (esquina superior derecha) para acceder a tu perfil y logout.

## Indicador de mensajes nuevos

El Dashboard se actualiza automáticamente cuando llegan mensajes nuevos (gracias al socket). Si ves el número de "Sin leer" subiendo, abrí el chat para responder.
